...
class Bdtaskt1MaterialStockModel extends Model
{
    ...
    public function bdtaskt1m12_02_getAll($postData=null){
        ...
        $builder3->select("bs.*, bw.nameE as store_name, branch.nameE as branch_name, wh_items.nameE as item_name, wh_items.item_code, list_data.nameE as unit_name, wh_items.company_code");
        if($searchQuery != ''){

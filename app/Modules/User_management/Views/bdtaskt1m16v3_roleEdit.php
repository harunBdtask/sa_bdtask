 <div class="row">
        <div class="col-sm-12">
            <div class="card card-bd lobidrag">
                ...
                <?php echo form_open('permission/roles/update', 'class="ajaxForm needs-validation" novalidate="" data="showCallBackData"') ?>
                <div class="card-body">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="role_name" id="type" maxlength="100" placeholder="<?php echo get_phrases(['enter', 'role','name']) ?>" value="<?php echo $role->type;?>" required />
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="title" id="title" maxlength="100" placeholder="<?php echo get_phrases(['enter', 'role','title']) ?>" value="<?php echo $role->title;?>" />
                        </div>
                    </div>
             <?php
            $m=0; 
                ...
                <table class="table table-bordered text-center">
                    ...
                    <?php if (!empty($value['subModule'])) { ?>
                        <?php foreach ($value['subModule'] as $key1 => $module_name) { ?>
                            ...
                            $class = 'all'.$m.$sl;
                            if(!empty($module_name->permission)){
                                $chkC = $module_name->permission->create==1?'checked':'';
                                $chkR = $module_name->permission->read==1?'checked':'';
                                $chkU = $module_name->permission->update==1?'checked':'';
                                $chkD = $module_name->permission->delete==1?'checked':'';
                                $chkP = $module_name->permission->print==1?'checked':'';
                                $chkE = $module_name->permission->export==1?'checked':'';
                            }else{
                                $chkC = '';
                                $chkR = '';
                                $chkU = '';
                            ...
                            <tr>
                                <td><?php echo ($sl+1) ?></td>
                                <td class="text-left">
                                    <?php if($module_name->label_no >1){
                                        for ($i=2; $i <= $module_name->label_no; $i++) { 
                                            echo '&nbsp;&nbsp;&nbsp;&nbsp;';
                                        }
                                        echo '<b>'.$module_name->parent_name.'</b>>';}?>
                                ...
                                <td>
                                    <div class="checkbox checkbox-success text-center">
                                         <input type="checkbox" name="create[<?php echo $m?>][<?php echo $sl?>][]" value="1" class="<?php echo $class;?>" <?php echo $createID?> <?php echo $chkC;?>>  
                                        <label for="create<?php echo $m ?><?php echo $sl ?>"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="checkbox checkbox-success text-center">
                                         <input type="checkbox" name="read[<?php echo $m?>][<?php echo $sl?>][]" value="1" class="<?php echo $class;?>" <?php echo $readID?> <?php echo $chkR;?>>
                                        <label for="read<?php echo $m ?><?php echo $sl ?>"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="checkbox checkbox-success text-center">
                                        <input type="checkbox" name="update[<?php echo $m?>][<?php echo $sl?>][]" value="1" class="<?php echo $class;?>" <?php echo $updateID?> <?php echo $chkU;?>>
                                        <label for="update<?php echo $m ?><?php echo $sl ?>"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="checkbox checkbox-success text-center">
                                         <input type="checkbox" name="delete[<?php echo $m?>][<?php echo $sl?>][]" value="1" class="<?php echo $class;?>" <?php echo $deleteID?> <?php echo $chkD;?>>
                                        <label for="delete<?php echo $m ?><?php echo $sl ?>"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="checkbox checkbox-success text-center">
                                         <input type="checkbox" name="print[<?php echo $m?>][<?php echo $sl?>][]" value="1" class="<?php echo $class;?>" <?php echo $printID?> <?php echo $chkP;?>>
                                        <label for="print<?php echo $m ?><?php echo $sl ?>"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="checkbox checkbox-success text-center">
                                         <input type="checkbox" name="export[<?php echo $m?>][<?php echo $sl?>][]" value="1" class="<?php echo $class;?>" <?php echo $exportID?> <?php echo $chkE;?>>

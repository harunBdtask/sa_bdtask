            ...
            <div class="card-header py-2">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <?php if($permission->method('leave_approval', 'create')->access()){ ?>
                        <!-- <a href="javascript:void(0);" class="btn btn-success btn-sm mr-1 addLeaveApplicationApproval"><i class="fas fa-plus mr-1"></i><?php //echo get_phrases(['add', 'leave', 'application']);?></a> -->
                        <?php }?>
...
<div class="modal fade bd-example-modal-xl" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('human_resources/leave_management/create_leave_approval', 'class="needs-validation" id="leaveApprovalForm" novalidate="" data="jobCallBackData"');?>
            <div class="modal-body">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="leave_aprv_strt_date" id="leave_aprv_strt_date" class="form-control only_leave_aprv_strt_date" placeholder="<?php echo get_phrases(['approve','start', 'date']);?>" autocomplete="off" required>
                        </div>
                   </div>
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="leave_aprv_end_date" id="leave_aprv_end_date" class="form-control only_leave_aprv_end_date" placeholder="<?php echo get_phrases(['approved','end', 'date']);?>" autocomplete="off" required>
                        </div>
                   </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['status']);?> <i class="">*</i></label>
...
<script type="text/javascript">
    var jobCallBackData = function () { 
        ...
        $('#leaveApprovalForm').removeClass('was-validated');    
    ...
    $(document).ready(function() { 
        ...
        $('#leaveFormList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'human_resources/leave_management/leave_application_list',
        ...
        // $('.addLeaveApplicationApproval').on('click', function(){
        ...
        //     $('#addModalLabel').text('<?php echo get_phrases(['leave', 'approval']);?>');
        ...
        $('#leaveFormList').on('click', '.actionEdit', function(e){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#addModalLabel').text('<?php echo get_phrases(['update', 'leave', 'approval']);?>');
                    $('#add-modal').modal('show');
                }
            });  
        });

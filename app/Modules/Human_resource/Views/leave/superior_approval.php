<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="superiorLeaveApprovalFormList" class="table display table-bordered table-striped table-hover compact" width="100%">
                    <thead>
                        <tr>
...
<div class="modal fade bd-example-modal-xl" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('human_resources/leave_management/update_leave_application_superior', 'class="needs-validation" id="superiorLeaveApprovalForm" novalidate="" data="jobCallBackData"');?>
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            ...
                            <?php echo form_dropdown('leave_type', $leave_types, '', 'class="form-control select2" id="leave_type" disabled');?>
                        </div>
                   </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="apply_strt_date" id="apply_strt_date" class="form-control only_apply_strt_date" placeholder="<?php echo get_phrases(['application','start', 'date']);?>" autocomplete="off" readonly>
                        </div>
                   </div>
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="apply_end_date" id="apply_end_date" class="form-control only_apply_end_date" placeholder="<?php echo get_phrases(['application','end', 'date']);?>" autocomplete="off" readonly>
                        </div>
                   </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="leave_aprv_strt_date" id="leave_aprv_strt_date" class="form-control only_leave_aprv_strt_date" placeholder="<?php echo get_phrases(['approve','start', 'date']);?>" autocomplete="off" readonly>
                        </div>
                   </div>
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="leave_aprv_end_date" id="leave_aprv_end_date" class="form-control only_leave_aprv_end_date" placeholder="<?php echo get_phrases(['approved','end', 'date']);?>" autocomplete="off" readonly>
                        </div>
                   </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            ...
                            <textarea name="reason" class="form-control" id="reason" rows="2" readonly></textarea>
                        </div>
                   </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['superior','approval']);?> <i class="">*</i></label>

                            <select name="superior_approval" id="superior_approval" class="custom-select form-control" required>
                               <option value=""><?php echo get_phrases(['select','option']);?></option>
                               <option value="1"><?php echo get_phrases(['approve']);?></option>
                               <option value="2"><?php echo get_phrases(['reject']);?></option>
                            </select>
                   ...
                   <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['superior','reason']);?> <i class="">*</i></label>
                            <textarea name="superior_reason" class="form-control" id="reason" rows="2"></textarea>
                        </div>
                   </div>
...
<script type="text/javascript">
    var jobCallBackData = function () { 
        ...
        $('#superiorLeaveApprovalForm')[0].reset();       
        $('#superiorLeaveApprovalForm').removeClass('was-validated');    
        $('#superiorLeaveApprovalFormList').DataTable().ajax.reload(null, false);
    }
    ...
    $(document).ready(function() { 
        ...
        $('#superiorLeaveApprovalFormList').DataTable({ 
             responsive: true,
             lengthChange: false,
             "aaSorting": [[ 3, "asc" ]],
             "columnDefs": [
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'human_resources/leave_management/superior_leave_application_list',
        ...
        $('#superiorLeaveApprovalFormList').on('click', '.actionEdit', function(e){
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#superior_approval').val(response.superior_approval).trigger('change');
                    $('#superior_reason').val(response.superior_approval_rsn);
        ...
        // // delete department
        // $('#superiorLeaveApprovalFormList').on('click', '.actionDelete', function(e){
        //     e.preventDefault();

        //     var id = $(this).attr('data-id');
            
        //     var submit_url = _baseURL+"human_resources/leave_management/delete_leave_application/"+id;

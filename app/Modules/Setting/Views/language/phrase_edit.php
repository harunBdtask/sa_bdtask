 ...
 <script>
    function updatePhrase(key){
        ...
        if(updatedValue){
            ...
            $.ajax({
                type : "POST",
                url  : _baseURL + 'settings/updatePhrase',
                data : {'csrf_stream_name':csrf_val, updatedValue : updatedValue, language : language, key : key},
                dataType: 'JSON',

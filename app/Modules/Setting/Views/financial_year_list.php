...
<div class="modal fade bd-example-modal-lg" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('settings/addFinancialYear', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#fyList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'settings/getFinancialYear',
        ...
        $('#fyList').on('click', '.actionEdit', function(e){
            ...
            var submit_url = _baseURL+'settings/getFyById';
        ...
        $('#fyList').on('click', '.actionActive', function(e){
            ...
            var submit_url = _baseURL+"settings/activateFyById";
        ...
        $('#fyList').on('click', '.actionAppClReq', function(e){
            ...
            var fy_id = $(this).attr('data-id');
            var submit_url = _baseURL+"settings/closeFinancialYear";

                ...
                <table id="main_stockList" class="table display table-bordered table-striped table-hover compact" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo get_phrases(['present','stock','(Bags)']);?></th>
                            <th><?php echo get_phrases(['present','stock','(KG)']);?></th>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#main_stockList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'finished_goods/getMainStockDetailsById/'+id;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#stockDetails_stock').text(data.stock+' Bags');
        ...
        $('#main_stockList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'finished_goods/getMainStock',
               'data':function ( d ) {
        ...
        $('#main_stockList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'finished_goods/getMainStockById/'+id;

                ...
                <table id="categoriesList" class="table display table-bordered table-striped table-hover compact" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo get_phrases(['category', 'name']);?></th>
                            <th><?php echo get_phrases(['category', 'code']);?></th>
...
<div class="modal fade bd-example-modal-xl" id="categories-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('finished_goods/add_categories', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
            <div class="modal-body">
                ...
                <div class="row form-group">
                    ...
                    <label for="code_no" class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['category', 'code']) ?> <i class="text-danger">*</i></label>
                    <div class="col-sm-4">
                        <input type="text" name="code_no" placeholder="<?php echo get_phrases(['enter', 'category', 'code']);?>" class="form-control" id="code_no" required>
...
<div class="modal fade bd-example-modal-xl" id="categoryDetails-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row form-group">
                    <label class="col-sm-2 text-right font-weight-600"><?php echo get_phrases(['category', 'name']) ?> : </label>
                    <div class="col-sm-4">
                        <div id="categoryDetails_nameE" ></div>
                        
                    </div>
                    <label class="col-sm-2 text-right font-weight-600"><?php echo get_phrases(['category', 'code']) ?> : </label>
                    <div class="col-sm-4">
                        <div id="categoryDetails_code_no"></div>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#categoriesList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'finished_goods/getCategoryDetailsById/'+id;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#categoryDetails_code_no').text(data.code_no);
        ...
        $('#categoriesList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'finished_goods/getCategories',
               'data':{'csrf_stream_name':csrf_val}
            },
          'columns': [
             { data: 'id' },
        ...
        $('.addShowModal').on('click', function(){
            ...
            getMAXID('wh_categories','id','code_no','CAT-');
        ...
        $('#categoriesList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'finished_goods/getCategoriesById/'+id;
        ...
        $('#categoriesList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"finished_goods/deleteCategories/"+id;

                ...
                <table id="main_storeList" class="table display table-bordered table-striped table-hover compact" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo get_phrases(['store', 'code']);?></th>
...
<div class="modal fade bd-example-modal-xl" id="main_store-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('finished_goods/add_main_store', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
            <div class="modal-body">
                ...
                <div class="row form-group">
                    ...
                    <label for="nameA" class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['store', 'code']) ?> <i class="text-danger">*</i></label>
                    <div class="col-sm-4">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row form-group">
                    ...
                    <label class="col-sm-2 text-right font-weight-600"><?php echo get_phrases(['store', 'code']) ?> : </label>
                    <div class="col-sm-4">
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#main_storeList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'finished_goods/getMainStoreDetailsById/'+id;
        ...
        $('#main_storeList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'finished_goods/getMainStore',
               'data':{'csrf_stream_name':csrf_val}
            },
          'columns': [
             { data: 'id' },
        ...
        $('#main_storeList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'finished_goods/getMainStoreById/'+id;
        ...
        $('#main_storeList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"finished_goods/deleteMainStore/"+id;

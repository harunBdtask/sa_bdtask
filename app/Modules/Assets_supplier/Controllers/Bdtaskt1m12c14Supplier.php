    ...
    { 
        ...
        if(!empty($data)){
            ...
            $list .= '<tr>             
                    ...
                    <tr>
                        <th class="text-right">'.get_phrases(['credit', 'limit']).'</th>
                        <td class="text-left">'.$data->credit_limit.'</td>
                        <th class="text-right">'.get_phrases(['SSN']).'</th>
                        <td class="text-left">'.$data->ssn.'</td>
                    </tr>
                    <tr>

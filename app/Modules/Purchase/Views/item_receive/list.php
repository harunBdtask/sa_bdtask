       ...
       <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">                    
                    ...
                    <div class="col-sm-3">
                        <label for="filter_supplier_id" class="font-weight-600"><?php echo get_phrases(['party', '(', 'supplier', ')']) ?> </label>
...
<div class="modal fade bd-example-modal-xl" id="item_receive-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog" >
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('purchase/add_item_receive', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
...
<script type="text/javascript">
    ...
    function reset_table(){
        ...
        $('#filter_date').val('');
        let table = $('#item_receiveList').DataTable();
    ...
    function get_po_list(){
        preloader_ajax();
        $.ajax({
            url: _baseURL+"purchase/get_po_list",
            type: 'POST',
    ...
    function get_purchase_details(purchase_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'purchase/getItemPurchaseDetailsById';
    ...
    $(document).ready(function() { 
        ...
        $('#item_receiveList').on('click', '.actionPreview', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'purchase/getItemReceiveDetailsById/'+id;
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
        ...
        $('#item_receiveList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'purchase/getItemReceive',
               'data':function ( d ) {
        ...
        $('#item_receiveList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"purchase/deleteItemReceive/"+id;
    ...
    function get_item_details(purchase_id, supplier_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'purchase/getItemPurchasePricingDetailsById';
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function item_info(item_id,sl){
        preloader_ajax();
        $.ajax({
            url: _baseURL+"purchase/getItemDetailsById/"+item_id,
            type: 'POST',
    ...
    function po_calculation_total() {
        ...
        var po_subtotal_price = 0;
        $(".po_subtotal_price").each(function () {
            po_subtotal_price += parseFloat(this.value);       
        });
        var vat_total = 0; 
        ...
        $("#po_subtotal_price").val(po_subtotal_price.toFixed(2));
        var grand_total = po_subtotal_price+vat_total;

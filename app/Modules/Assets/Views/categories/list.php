...
<div class="modal fade bd-example-modal-xl" id="categories-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('wh_assets/add_categories', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"'); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#categoriesList').on('click', '.actionPreview', function(e) {
            ...
            var submit_url = _baseURL + 'wh_assets/getCategoryDetailsById/' + id;
        ...
        $('#categoriesList').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': _baseURL + 'wh_assets/getCategories',
                'data': {
                    'csrf_stream_name': csrf_val
                }
            },
        ...
        $('#categoriesList').on('click', '.actionEdit', function(e) {
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL + 'wh_assets/getCategoriesById/' + id;
        ...
        $('#categoriesList').on('click', '.actionDelete', function(e) {
            ...
            var submit_url = _baseURL + "wh_assets/deleteCategories/" + id;

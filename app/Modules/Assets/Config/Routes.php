...
$routes->group('wh_assets', ['namespace' => 'App\Modules\Assets\Controllers'], function($subroutes){
    ...
    $subroutes->add('add_categories', 'Bdtaskt1m12c1Categories::bdtaskt1m12c1_03_add_categories');

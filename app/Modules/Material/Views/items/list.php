       ...
       <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">                    
                    <div class="col-sm-3">
                        <label for="filter_cat_id" class="font-weight-600"><?php echo get_phrases(['category']) ?> </label>
...
<div class="modal fade bd-example-modal-xl" id="items-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('material/add_items', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
            <div class="modal-body">
                ...
                <div class="row form-group">
                    ...
                    <label for="store_id" class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['where','store']) ?> <i class="text-danger">*</i></label>
                    <div class="col-sm-4">
                        <select name="store_id" id="store_id" class="custom-select form-control" required>
                            <option value=""><?php echo get_phrases(['select','store']) ?></option>
                            <?php if(!empty($stores)){ ?>
                ...
                <div class="row form-group">
                    <label for="wastage" class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['standard', 'wastage','%']) ?> </label>
                    <div class="col-sm-4">
                        <input type="text" name="wastage" placeholder="<?php echo get_phrases(['standard', 'wastage','%']);?>" class="form-control onlyNumber" id="wastage">                        
                    </div>
                    <label for="expire" class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['expiry']) ?> <i class="text-danger">*</i></label>
                    <div class="col-sm-4">
                        <select name="expire" id="expire" class="custom-select form-control" required>
                            <option value=""><?php echo get_phrases(['enable','expire']) ?></option>
                            <?php
                                $exp_data = array('no'=>'No','yes'=>'Yes'); 
                                if(!empty($exp_data)){ ?>
                ...
                <div class="row form-group">
                    <label for="aprox_monthly_consumption" class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['monthly','consumption']) ?></label>
                    <div class="col-sm-4">
                        <input type="text" name="aprox_monthly_consumption" placeholder="<?php echo get_phrases(['enter','quantity']);?>" class="form-control onlyNumber" id="aprox_monthly_consumption">                        
                    </div>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#itemsList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'material/getItemDetailsById/'+id;
        ...
        $('#itemsList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'material/getItems',
               'data':function ( d ) {
        ...
        $('.addShowModal').on('click', function(){
            ...
            getMAXID('wh_material','id','item_code','ITEM-');
        ...
        $('#itemsList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'material/getItemsById/'+id;
        ...
        $('#itemsList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"material/deleteItems/"+id;

<div class="row">
    <div class="col-sm-12">
        <?php if($permission->method('patient_statement', 'create')->access() || $permission->method('patient_statement', 'read')->access()){ ?>
        <div class="card">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="patient_id" class="col-form-label-custom font-weight-600"><?php echo get_phrases(['patient', 'name']) ?> <i class="text-danger">*</i></label>
                                    <?php echo form_dropdown('patient_id','','','class="custom-select" id="patient_id" required="required"');?>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label for="patient_date" class="col-form-label-custom font-weight-600"><?php echo get_phrases(['date', 'range']) ?> <i class="text-danger">*</i></label>
                                    <input type="text" name="patient_date" id="patient_date" class="form-control reportrange1" autocomplete="off" placeholder="<?php echo get_phrases(['select', 'date']);?>" required>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group mt-3 py-1">
                                    <button type="submit" class="btn btn-sm btn-success rounded-pill mt-1 patientBtn"><?php echo get_phrases(['filter']);?></button>
                                </div>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#patient_id').on('change', function(e){
            ...
            var submit_url = _baseURL+"reports/account/getPatientInfoById"; 
            $.ajax({
                type: 'POST',
                url: submit_url,
        ...
        $('.patientBtn').on('click', function(e){
            e.preventDefault();

            var branchId  = $('#branch_id').val();
            var userId    = $('#patient_id').val();

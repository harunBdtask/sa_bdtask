    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('.userIBtn').on('click', function(e){
            ...
            var machine_id = 0;//$('#machine_id').val();
            var date = $('#date').val();
            /*if(machine_id =='' ){
            ...
            var submit_url = _baseURL+"reports/machine/get_daily_consumption"; 
            $.ajax({
                type: 'POST',
                url: submit_url,
                ...
                success: function(res) {
                    ...
                    $('#title').text('<?php echo get_phrases(['Daily','raw','material','Stock', 'Position']).', Date: ';?>'+date);

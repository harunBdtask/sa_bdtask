<div class="row">
    <div class="col-sm-12">
        <?php 
        if($permission->method('redeem_points_report', 'create')->access()){ ?>
        <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <?php 
                                $column = array(
                                    ...
                                    'sid.redeem_points'=> get_phrases(['redemm', 'points']),
                                    'sid.redeem_discount'=> get_phrases(['value', 'of', 'points']),
                                    'sid.remaining_points'=> get_phrases(['remaining', 'points'])
                                );
...
<script type="text/javascript">
    ...
    function get_data(dir){
        ...
        var submit_url = _baseURL+"reports/pointing/redeemReports";
        if(date_range !=''){
            preloader_ajax();
            $.ajax({
                type: 'POST',

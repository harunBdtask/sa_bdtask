...
<h4 class="mb-0"><center><?php echo get_notify('income_without_vat_reports');?></center></h4>
...
<div class="table-responsive">
    <table class="table table-stripped table-sm">
        <thead>
                ...
                <th width="13%"><?php echo get_phrases(['patient', 'name']);?></th>
                <th width="8%"><?php echo get_phrases(['nationality']);?></th>
                <th width="9%"><?php echo get_phrases(['id', 'no']);?></th>
                <th width="13%"><?php echo get_phrases(['doctor', 'name']);?></th>
                ...
                <th width="10%"><?php echo get_phrases(['created', 'date']);?></th>
            </tr>
        </thead>
        <tbody> 
           <?php 

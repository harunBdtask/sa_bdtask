...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('.userIBtn').on('click', function(e){
            ...
            var submit_url = _baseURL+"reports/inventory/get_item_sub_stock"; 
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function preview(obj){
            ...
            var submit_url = _baseURL+'reports/inventory/getSubStoreItemReceiveDetails';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#itemReceiveDetailsModalLabel').text('<?php echo get_phrases(['item','stock','balance','details']);?>');

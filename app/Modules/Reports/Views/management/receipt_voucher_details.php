...
<div class="row">
  <div class="col-12 col-md-5">
      ...
      <p class="text-muted mb-4">
          ...
          <?php if(!empty($results->isCredit)){ ?>
            <span class="text-success viewVoucher clickable-row" data-id="<?php echo esc($results->isCredit);?>" data-type="SINV"><?php echo get_phrases(['referance', 'credit', 'invoice', 'id']);?> - <?php echo esc($results->isCredit);?></span>
          <?php }?>
      </p>
  </div>
  ...
  <div class="col-md-12">
    <div class="table-responsive">
      <table class="table table-stripped table-sm">
          <thead>
              <tr>
                  <th width="10%"><?php echo get_phrases(['code', 'no']);?></th>
                  <th width="45%"><?php echo get_phrases(['service', 'name']);?></th>
                  <th class="text-center" width="5%"><?php echo get_phrases(['qty']);?></th>
                  <th class="text-right" width="10%"><?php echo get_phrases(['price']);?></th>
                  <th class="text-right" width="10%"><?php echo get_phrases(['discount']);?></th>
                  <th class="text-right" width="10%"><?php echo get_phrases(['vat']);?></th>
            ...
            <?php 
              ...
              foreach ($results->details as $value) {   
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo number_format(esc($value->discount), 2);?></td>
                  <td class="text-right"><?php echo number_format(esc($results->vat), 2);?></td>
       ...
       <table class="table table-bordered" cellspacing="0" width="100%">
          <tfoot>
              ...
              <tr>
                  ...
                  <th class="text-right"><?php echo getPriceFormat($results->receipt);?></th>
              </tr>
              <tr>
                 <td class="text-right">
                      <b><?php echo get_phrases(['total', 'due'])?></b></td>
                  <th  class="text-right"><?php echo getPriceFormat($results->isPaid==2?$results->receipt:$results->due);?></th>
              </tr>
            </tfoot>
      </table>
  </div>

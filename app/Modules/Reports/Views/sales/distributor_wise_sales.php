                ...
                <div class="row">
                    <div class="col-sm-2 text-right">
                        <div class="form-group">
                            <strong><?php echo get_phrases(['employee','list']); ?></strong> <i class="text-danger">*</i>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.userIBtn').on('click', function(e) {
            ...
            if(category_id =='' ){
                toastr.warning('<?php echo get_notify('Select_employee'); ?>');
                return
            }

            var submit_url = _baseURL + "reports/sales/distributor_wise_sales_table";
            $.ajax({
                type: 'POST',
                url: submit_url,
                data: {

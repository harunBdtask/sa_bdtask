        ...
        <tbody>
           ...
           if(!empty($results)){
                foreach ($results as $value) { 
                  ...
                  $out_qty = $value->req_qty-$value->req_ret_qty;
                  if( $out_qty <0 ){
                    $out_qty = 0;
                  }
                  ...
                  */
                  ...
                  ?>
                   <tr onclick="onclick_change_bg('.detailsTable', this, 'cyan')">
                       ...
                       <td class="text-right"><a href="javascript:void(0)" onclick="preview(this)" data-id="<?php echo esc($value->item_id);?>" warehouse-id="<?php echo esc($value->store_id);?>"><?php echo esc(number_format($in_qty, 2));?></a></td>
                       <td class="text-right"><a href="javascript:void(0)" onclick="preview(this)" data-id="<?php echo esc($value->item_id);?>" warehouse-id="<?php echo esc($value->store_id);?>"><?php echo esc(number_format($out_qty, 2));?></a></td>
                       <td class="text-right"><a href="javascript:void(0)" onclick="preview(this)" data-id="<?php echo esc($value->item_id);?>" warehouse-id="<?php echo esc($value->store_id);?>"><?php echo esc(number_format($stock_qty, 2));?></a></td>

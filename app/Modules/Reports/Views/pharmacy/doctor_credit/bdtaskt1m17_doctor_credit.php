                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">                           
                            <label class="font-weight-600"><?php echo get_phrases(['doctor']);?>  <i class="text-danger">*</i></label>
                            <select name="doctor_id" id="doctor_id" class="form-control custom-select" required>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('.userIBtn').on('click', function(e){
            ...
            if(doctor_id ==''){
                toastr.warning('<?php echo get_notify('Select__doctor'); ?>');
                return
            }
            if(date_range =='' ){
            ...
            var submit_url = _baseURL+"reports/pharmacy/get_doctor_credit"; 
            $.ajax({
                type: 'POST',
                url: submit_url,
                ...
                success: function(res) {
                    ...
                    $('#title').text('<?php echo get_phrases(['credit','by','doctor','list']);?> for '+date_range);

    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="print_button" onclick="printContent('printContent')"><?php echo get_phrases(['print']);?></button>
...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('.userIBtn').on('click', function(e){
            ...
            var submit_url = _baseURL+"reports/pharmacy/get_supplier_aging"; 
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function preview(obj){
            ...
            var submit_url = _baseURL+'pharmacy/getItemReceiveDetailsById/'+id;
    ...
    function get_item_details(purchase_id, type){

        if(purchase_id !='' ){
            var submit_url = _baseURL+'pharmacy/getItemPricingDetailsById';

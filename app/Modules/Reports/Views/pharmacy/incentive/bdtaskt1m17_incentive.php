        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">                           
                            <label class="font-weight-600"><?php echo get_phrases(['category']);?> </label>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('.userIBtn').on('click', function(e){
            ...
            var submit_url = _baseURL+"reports/pharmacy/get_incentive"; 
            $.ajax({
                type: 'POST',
                url: submit_url,
                data: {'csrf_stream_name':csrf_val, supplier_id:supplier_id, doctor_id:doctor_id, category_id:category_id, date_range:date_range},
                dataType: 'JSON',
                success: function(res) {
                    $('#results').html('');
                    $('#results').html(res.data);
                    $('#title').text('<?php echo get_phrases(['doctor','incentives']);?>');

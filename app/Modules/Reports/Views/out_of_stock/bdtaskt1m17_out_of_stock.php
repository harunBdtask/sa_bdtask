    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('.userIBtn').on('click', function(e){
            ...
            var submit_url = _baseURL+"reports/inventory/get_out_of_stock"; 
            $.ajax({
                type: 'POST',
                url: submit_url,
                data: {'csrf_stream_name':csrf_val, store_id:store_id, store_id:store_id},
                dataType: 'JSON',
                success: function(res) {
                    $('#results').html('');
                    $('#results').html(res.data);
                    $('#title').text('<?php echo get_phrases(['out','of', 'stock', 'item', 'list']);?>');

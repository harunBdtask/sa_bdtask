    ...
    <table class="table table-stripped table-sm table-hover detailsTable">
        <thead>
            <tr>
                ...
                <th width="30%">Name of Items</th>
                <th width="5%">CODE</th>
                <th width="10%">Bag Capacity</th>
                <th width="10%" class="text-right">Opening Stock (Pcs)</th>
                <th width="10%" class="text-right">Received (Pcs)</th>
                <th width="10%" class="text-right">Total (Pcs)</th>
                <th width="10%" class="text-right">Used (Pcs)</th>
                <th width="10%" class="text-right">Closing Stock (Pcs)</th>
            </tr>
        </thead>
        <tbody>
           <?php 
                ...
                foreach ($results as $value) { 
                  ...
                  ?>
                   <tr onclick="onclick_change_bg('.detailsTable', this, 'cyan')">
                       ...
                       <td><?php echo esc($value->bag_weight);?></td>

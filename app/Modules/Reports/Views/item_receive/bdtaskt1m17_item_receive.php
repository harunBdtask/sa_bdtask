            ...
            <div class="modal-body" id="printContent">
                <div class="row printing_info">
                    <div class="col-sm-12 text-center">
                        <h5><?php echo get_phrases(['item','received','from','supplier']) ?></h5>
                ...
                <div class="row">
                    <label class="col-sm-10 text-right font-weight-600"><?php echo get_phrases(['due']) ?> : </label>
                    <div class="col-sm-2 text-right">
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('.userIBtn').on('click', function(e){
            ...
            var submit_url = _baseURL+"reports/inventory/get_item_receive"; 
            $.ajax({
                type: 'POST',
                url: submit_url,

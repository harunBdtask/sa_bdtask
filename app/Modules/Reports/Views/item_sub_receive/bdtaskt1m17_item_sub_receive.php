            ...
            <div class="modal-body" id="printContent">
                ...
                <div class="row printing_info">
                    <div class="col-sm-12 text-center">
                        <h5><?php echo get_phrases(['item','received', 'from','store']) ?></h5>
                ...
                <div class="row">
                    <label class="col-sm-2 text-right font-weight-600"><?php echo get_phrases(['from','sub','store']) ?> : </label>
                    <div class="col-sm-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('.userIBtn').on('click', function(e){
            ...
            var submit_url = _baseURL+"reports/inventory/get_item_sub_receive"; 
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function preview(obj){
            ...
            var submit_url = _baseURL+'inventory/getItemRequestDetailsById/'+id;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#itemRequestDetailsModalLabel').text('<?php echo get_phrases(['item','request','details']);?>');
    ...
    function get_item_details(request_id){
        ...
        if(request_id !='' ){
            var submit_url = _baseURL+'inventory/getItemRequestQuantityDetailsById';

...
use App\Modules\Reports\Models\Bdtaskt1m17ProductionReportModel;
...
class Bdtaskt1m17c8ProductionReports extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->bdtaskt1m17c2_01_rptModel = new Bdtaskt1m17ProductionReportModel();
    ...
    | item stock form
    *--------------------------*/
    public function bdtaskt1m17c8_01_dailyProduction()
    {

        $data['title']      = get_phrases(['daily','production']);
        $data['moduleTitle']= get_phrases(['reports']);
        $data['isDateTimes']= true;
        $data['module']     = "Reports";
        $data['page']       = "daily_production/form";

        $data['category_list']       = $this->bdtaskt1m17c2_02_CmModel->bdtaskt1m1_05_getResultWhere('wh_categories', array('status'=>1));
    ...
    | Get item stock
    *--------------------------*/
    public function bdtaskt1m17c8_02_getDailyProduction()
    { 
        ...
        $data['hasPrintAccess']        = $this->permission->method('daily_production', 'print')->access();
        $data['hasExportAccess']        = $this->permission->method('daily_production', 'export')->access();

        $data['setting']    = $this->bdtaskt1m17c2_02_CmModel->bdtaskt1m1_03_getRow('setting');
        $data['results']   = $this->bdtaskt1m17c2_01_rptModel->bdtaskt1m17_01_getDailyProduction($cat_id, $from, $to);

        $income = view('App\Modules\Reports\Views\daily_production\reports', $data);

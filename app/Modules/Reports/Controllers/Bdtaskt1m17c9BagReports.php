...
use App\Modules\Reports\Models\Bdtaskt1m17BagReportModel;
...
class Bdtaskt1m17c9BagReports extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->bdtaskt1m17c2_01_rptModel = new Bdtaskt1m17BagReportModel();
    ...
    | item stock form
    *--------------------------*/
    public function bdtaskt1m17c9_01_bag_stock()
    {

        $data['title']      = get_phrases(['bag','stock','report']);
        $data['moduleTitle']= get_phrases(['reports']);
        $data['isDateTimes']= true;
        $data['module']     = "Reports";
        $data['page']       = "bag_stock/form";
    ...
    | Get item stock
    *--------------------------*/
    public function bdtaskt1m17c9_02_get_bag_stock()
    { 
        ...
        $data['hasPrintAccess']        = $this->permission->method('bag_stock', 'print')->access();
        $data['hasExportAccess']        = 0;//$this->permission->method('bag_stock', 'export')->access();
        ...
        $income = view('App\Modules\Reports\Views\bag_stock\reports', $data);

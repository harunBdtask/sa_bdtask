        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">
                    ...
                    <div class="col-sm-2">
                        <label for="filter_name" class="font-weight-600"><?php echo get_phrases(['SPR']) ?> </label>
                ...
                <table id="quatationList" class="table display table-bordered table-striped table-hover compact" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo get_phrases(['party', '(', 'supplier', ')']); ?></th>
...
<div class="modal fade bd-example-modal-xl" id="item_purchase-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog" >
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('assets_purchase/add_quatation', 'class="po_ajaxForm needs-validation" id="po_ajaxForm" novalidate="" data="showCallBackData"');?>
            <div class="modal-body">
                ...
                <input type="hidden" name="action" id="po_action" value="add" />
                    <div class="row form-group">
                        ...
                        <label for="supplier_id" class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['party', '(', 'supplier', ')']) ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                    ...
                    <div class="row mt-2">
                         <table class="table table-sm table-stripped w-100" id="purchase_table">
                            <thead>
                                <tr>
                                    <th width="15%" class="text-center"><?php echo get_phrases(['assets', 'name'])?><i class="text-danger">*</i></th>
                    ...
                    <div id="terms_conditions" class="row">                    
                        <label class="col-sm-1 font-weight-600"><?php echo get_phrases(['terms', 'conditions']) ?> : </label>
                        <div class="col-sm-10">
                            <textarea name="terms_conditions" id="summernote" rows="10" cols="80" ></textarea>
                        </div>
                    </div>
...
<div class="modal fade bd-example-modal-xl" id="purchaseOrderDetails-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('assets_purchase/requisition_approve', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData55"');?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" onclick="downloadContent('printContent')"><?php echo get_phrases(['download']);?></button>
            </div>
            <?php echo form_close();?>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function reload_table(){
        ...
        if (filter_name != '') {
            var submit_url = _baseURL+'assets_purchase/getSpr';
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    $(document).ready(function() {
        ...
        $('#quatationList').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': _baseURL + 'assets_purchase/getQuatation',
                'data':function ( d ) {
        ...
        $('#quatationList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'assets_purchase/getSprDetailsById/'+id;
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
        ...
        $('#quatationList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            $('#po_id').val(id);
            var submit_url = _baseURL+'assets_purchase/getQuatationById/'+id;
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
        ...
        $('#quatationList').on('click', '.actionDelete', function(e) {
            ...
            var submit_url = _baseURL + "assets_purchase/deleteQuatation/" + id;
        ...
        $('#quatationList').on('click', '.actionPrintPreview', function(e){
            e.preventDefault();
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'bag_purchase/getPrintView';
    ...
    function downloadContent(id) {
        var html = $("#"+id).html();
        var submit_url = _baseURL+'assets_purchase/quatation_dompdf';
        preloader_ajax();
        $.ajax({
            type: 'POST',
            url: submit_url,
    ...
    function get_item_details(spr_id, quatation_id){
        if(spr_id !='' ){
            var submit_url = _baseURL+'assets_purchase/getQuatationPricingDetailsById';
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function get_item_list(requisition_id, qid){
        preloader_ajax();
        $.ajax({
            url: _baseURL+"assets_purchase/get_spr_list",
            type: 'POST',
    ...
    function get_item_details_edit(purchase_id){
        if(purchase_id !='' ){
            var submit_url = _baseURL+'assets_purchase/get_quatation_details_by_id';
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function po_item_info(item_id,sl){
        if (item_id != '') {
            ...
            preloader_ajax();
            $.ajax({
                url: _baseURL+"assets_purchase/getSprItemDetailsById",
                type: 'POST',

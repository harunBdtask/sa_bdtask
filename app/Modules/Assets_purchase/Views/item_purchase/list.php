...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#item_purchaseList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'assets_purchase/getMaterialReceiveDetailsById/'+id;
        ...
        $('#item_purchaseList').on('click', '.actionPreviewReturn', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'assets_purchase/getReturnDetailsById/'+id;
        ...
        $('#item_purchaseList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'assets_purchase/getItemPurchase',
               'data': function ( d ) {
        ...
        $('#item_purchaseList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'assets_purchase/getItemPurchaseById/'+id;
        ...
        $('#item_purchaseList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"assets_purchase/deleteItemPurchase/"+id;
    ...
    function get_item_details(purchase_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'assets_purchase/getItemPricingDetailsById';
    ...
    function get_return_item_details(purchase_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'assets_purchase/getReturnItemDetailsById';

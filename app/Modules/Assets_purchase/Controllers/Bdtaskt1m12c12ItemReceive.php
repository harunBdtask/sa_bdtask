...
use App\Modules\Assets_purchase\Models\Bdtaskt1m12ItemReceiveModel;
...
class Bdtaskt1m12c12ItemReceive extends BaseController
{
    ...
    *--------------------------*/
    public function index()
    {
        ...
        $data['store_list']             = $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_05_getResultWhere('wh_bag_store', array('status'=>1,'branch_id'=>session('branchId')));
        ...
        $data['item_list']              = $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_05_getResultWhere('wh_assets', array('status'=>1));
        ...
        $store_list         = $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_03_getRow('wh_bag_store', array('status'=>1,'branch_id'=>session('branchId')));
    ...
    *--------------------------*/
    ...
    { 
        $data = $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_06_Deleted('wh_bag_requisition', array('id'=>$id,'type'=>2));
    ...
    *--------------------------*/
    ...
    { 
        ...
        if (! $this->validate($rules)) {
            ...
            if($action=='add'){
                $isExist = $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_03_getRow('wh_bag_requisition', array('voucher_no'=>$this->request->getVar('voucher_no'),'type'=>2));
                ...
                $result = $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_02_Update('wh_bag_requisition',$data, array('id'=>$id,'type'=>2));
                if($result){
                     $response = array(
                        'success'  =>true,
    ...
    *--------------------------*/
            ...
            if($action=='receive'){
                ...
                if( !empty($isExist)  ){
                    ...
                    if($result){
                        ...
                        $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_02_Update('wh_bag_purchase',array('received'=>$received), array('id'=>$purchase_id));
                    ...
                    for($i=1; $i<=$item_counter; $i++){
                        ...
                        if ($quantity > 0) {
                            $data2[] = array('receive_id'=> $result,'store_id'=> $store_id,'purchase_id'=> $purchase_id,'item_id'=> $item_id, 'qty'=> $quantity, 'avail_qty'=> $quantity, 'remarks'=> $remarks, 'qc_attachment'=> $qc_attachment );
    ...
    public function bdtaskt1m12c12_04_truncate_item_stock()
    {
        ...
        $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_22_addActivityLog(get_phrases(['truncate','wh_assets','stock']), get_phrases(['deleted']), 1, 'wh_bag_receive');
        echo 200;
    ...
    *--------------------------*/
    ...
    { 
        ...
        {
            $item_row = $this->bdtaskt1m12c12_02_CmModel->bdtaskt1m1_03_getRow('wh_assets', array('id'=>$details->item_id));
            ...
            if (!empty($item_row)) {
                ...
                if ($avail_qty != 0) {
                    ...
                    $html .= '<tr>
                                ...
                                <td align="right"><input type="number" name="qty'.$item_counter.'" id="qty'.$item_counter.'" onkeyup="po_calculation('.$item_counter.')" class="form-control text-right"/></td>

<div class="row"> 
    <div class="col-sm-12">
        <?php if($permission->module('branch_balance_transfer')->access()){ ?>
        <div class="card">
            <div class="card-header py-2">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <?php if($permission->method('branch_balance_transfer', 'create')->access()){ ?>
                ...
                <table id="approvalList" class="table display table-bordered table-striped table-hover compact" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo get_phrases(['from', 'branch']);?></th>
                            <th><?php echo get_phrases(['to', 'branch']);?></th>
...
<div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('account/balanceTransfer/saveBranchToBranch', 'class="needs-validation" id="transForm" novalidate="" data="transCallBackData"');?>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <input type="hidden" name="from_branch" id="from_branch" value="<?php echo session('branchId');?>">
                        <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['branch', 'name']);?></label>
                            <input type="text" class="form-control" value="<?php echo $top_branch_name;?>" readonly="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['branch', 'to']);?> <i class="text-danger">*</i></label>
                            <?php echo form_dropdown('to_branch', '', '', 'class="custom-select" id="to_branch" required');?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['patient', 'name']);?> <i class="text-danger">*</i></label>
                            <?php echo form_dropdown('patient_id', '', '', 'class="custom-select" id="patient_id" required');?>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['current', 'balance']);?></label>
                            <input type="text" name="current_blnc" id="current_blnc" class="form-control" value="0.00" readonly="">
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="status-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="trans_id" id="app_trans_id" class="form-control" required readonly="">
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['transfer', 'date']);?></label>
                            <input type="text" name="trans_date" id="app_trans_date" class="form-control" readonly="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <input type="hidden" name="from_branch" id="from_branch">
                        <div class="form-group">
                            <input type="hidden" name="from_branch" id="app_from_branch">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['from', 'branch']);?></label>
                            <input type="text" class="form-control" id="app_from_branch_name" readonly="">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['to', 'branch']);?></label>
                            <input type="hidden" name="to_branch" id="app_to_branch">
                            <input type="text" id="app_to_branch_name" class="form-control" readonly="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['patient', 'name']);?></label>
                            <input type="hidden" name="patient_id" id="app_patient_id">
                            <input type="hidden" name="head_code" id="app_head_code">
                            <input type="text" name="patient_name" id="app_patient_name" class="form-control" readonly="">
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                       <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['current', 'balance']);?></label>
                            <input type="text" name="app_current_blnc" id="app_current_blnc" class="form-control" value="0.00" readonly="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="trans_amount" id="app_trans_amount" class="form-control" readonly="">
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
...
<div class="modal fade" id="view-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
        ...
        $('#approvalList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'account/balanceTransfer/branchToBranchBal',
        ...
        function uuidv4() {
          return 'Txxx-xxxx-xxxxx'.replace(/[xy]/g, function(c) {
        ...
        $('#approvalList').on('click', '.statusAction', function(e){
            ...
            var submit_url = _baseURL+"account/balanceTransfer/branchTransById/"+id; 
            $.ajax({
                type: 'POST',
                url: submit_url,
                data: {'csrf_stream_name':csrf_val},
                ...
                success: function(res) {
                    console.log(res);
                    $('#transId').val(res.id);
                    $('#app_from_branch').val(res.branch_id);
                    $('#app_to_branch').val(res.to_branch);
                    $('#app_from_branch_name').val(res.from_branch_name);
                    $('#app_to_branch_name').val(res.to_branch_name);
                    $('#app_patient_id').val(res.patient_id);
                    $('#app_patient_name').val(res.patient_name);
                    $('#app_head_code').val(res.head_code);
                    $('#app_trans_id').val(res.trans_id);
                    $('#app_trans_date').val(res.trans_date);
                    $('#app_current_blnc').val(res.balance);
                    $('#app_trans_amount').val(res.amount);
        ...
        $.ajax({
            type:'GET',
            url: _baseURL+'account/balanceTransfer/branchList',
            dataType: 'json',
            data:{'csrf_stream_name':csrf_val},
        }).done(function(data) {
            $("#to_branch").select2({
        ...
        $('#patient_id').select2({
            ...
            minimumInputLength: 3,
                ajax: {
                    url: _baseURL+'reports/account/searchPatientAcc',
                    dataType: 'json',
                    delay: 250,
        ...
        $('#trans_amount').on('keyup', function(e){
            e.preventDefault();
            var currB = parseFloat($('#current_blnc').val());
            var amount = parseFloat($(this).val());
            if(amount >currB){
                toastr.warning('<?php echo get_notify('You_could_not_exceed_current_Balance');?> '+currB);
        ...
        $('#patient_id').on('change', function(e){
            ...
            var submit_url = _baseURL+"account/balanceTransfer/balanceByCode/"+id+'/'+branch_id; 
            $.ajax({
                type: 'POST',
                url: submit_url,
                data: {'csrf_stream_name':csrf_val},

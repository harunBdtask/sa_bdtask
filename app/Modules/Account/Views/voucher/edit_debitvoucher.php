  ...
  <div class="col-md-6 col-sm-12">
    ...
    <div class="form-group">
      <label class="font-weight-600 mb-0">
        <?php echo get_phrases(['credit', 'account', 'head']); ?>
        <i class="text-danger">*
        </i>
      </label>
        ...
        <thead>
          <tr>
            <th class="text-center" width="45%">
              <?php echo get_phrases(['debit', 'head']); ?>
              <i class="text-danger">*
              </i>
            </th>
...
?>
          <tr>
            ...
            <td>
              <input type="text" name="amount[]" class="form-control editamount onlyNumber text-right" autocomplete="off" onkeyup="edittotalCalcuation()" value="<?php echo $row->Debit ;?>" required>
            </td>
            <td>

    ...
    <table class="table table-bordered table-sm mt-2">
        ...
        <tbody>
            ...
            if(!empty($results)){
             ...
             $style = $k % 2 ? '#efefef!important' : '';?>
                  <tr>
            		<td style="background:<?php echo $style; ?>"><strong style="font-size: 15px;"><?php echo esc($row->revhead);?></strong><br>
                    <span> <?php echo $row->ledgerComment?></span>
                </td>
            		<td class="text-right" style="background:<?php echo $style; ?>"><?php echo esc($row->Credit);?></td>
            		<td class="text-right" style="background:<?php echo $style; ?>"><?php echo esc($row->Debit);?></td>
        ...
        <tfoot>
            ...
            <tr>
        		...
        		<th class="" colspan="3"><?php echo get_phrases(['in','words']);?> : <?php echo $numberToword->AmountInWords($Credit); ?></th>
        		
        	</tr>
            <tr>
        		
        		
        		<th class="" colspan="3" style="background:<?php echo $style; ?>"><?php echo get_phrases(['remarks']);?> : <?php echo $results->Narration; ?></th>
        	</tr>
        </tfoot>
    </table>

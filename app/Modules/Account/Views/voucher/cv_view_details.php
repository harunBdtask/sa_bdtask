...
<div class="row">
               ...
               <div class="col-md-6 text-center">
                  ...
                  <strong><u class="pt-4"><?php echo 'Credit Voucher'; ?></u></strong>
                </div>
    ...
    <table class="table table-bordered table-sm mt-2">
        ...
        <tbody>
            ...
            $k = $k + 1 ;
             $style = $k % 2 ? '#efefef!important' : '';?>
            <tr>
                <td class="text-left <?php echo $k % 2 ? 'cv' : '' ?>" style="background:<?php echo $style; ?>"><strong style="font-size: 15px;"><?php echo $results->dbtcrdHead;?></strong></td>
                <td class="text-right" style="background:<?php echo $style; ?>"><?php echo number_format($row->Credit, 2); ?></td>
                <td class="text-right" style="background:<?php echo $style; ?>"><?php echo esc($row->Debit);?></td>
        ...
        <tfoot>
        	...
        	<tr class="<?php echo $k % 2 ? 'cv' : '' ?>">
        		...
        		<th class="text-right" style="background:<?php echo $style; ?>"><?php echo number_format(($Credit?$Credit:$Debit), 2); ?></th>
        		<th class="text-right" style="background:<?php echo $style; ?>"><?php echo number_format(($Debit?$Debit:$Credit), 2); ?></th>
        	</tr>
             <?php $k = $k + 1 ;
             $style = $k % 2 ? '#efefef!important' : '';?>
            <tr class="<?php echo $k % 2 ? 'cv' : '' ?>">
        		
        		<th class="" colspan="3" style="background:<?php echo $style; ?>"><?php echo get_phrases(['in','words']);?> : <?php echo $numberToword->AmountInWords(($Credit?$Credit:$Debit)); ?></th>

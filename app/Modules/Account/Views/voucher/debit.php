...
<div class="row">
    <div class="col-sm-12">
        <?php
        $hasPrintAccess  = $permission->method('debit_voucher', 'print')->access();
        $hasExportAccess = $permission->method('debit_voucher', 'export')->access();
        if ($permission->module('debit_voucher')->access()) { ?>
            <div class="card">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <?php if ($permission->method('debit_voucher', 'create')->access()) { ?>
                                <a href="javascript:void(0);" class="btn btn-success btn-sm mr-1 addDebit"><i class="fas fa-plus mr-1"></i><?php echo get_phrases(['debit', 'voucher']); ?></a>
                            <?php } ?>
                    ...
                    <table id="approvalList" class="table display table-bordered table-striped table-hover compact" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo get_phrases(['credit', 'head']); ?></th>
    ...
    <div class="modal-dialog modal-xl c">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-600" id="addModalLabel"><?php echo get_phrases(['add', 'debit', 'voucher']); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?php echo form_open_multipart('account/vouchers/saveDebitVoucher', 'class="needs-validation" id="debitForm" novalidate="" data="debitCallBackData"'); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label class="font-weight-600 mb-0"><?php echo get_phrases(['credit', 'account', 'head']); ?> <i class="text-danger">*</i></label>
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-stripped table-sm">
                                <thead>
                                    <tr>
                                        <th class="text-center" width="45%"><?php echo get_phrases(['debit', 'head']); ?><i class="text-danger">*</i></th>
                                ...
                                <tfoot>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td class="text-right mt-2"><label class="font-weight-600 mb-0"><?php echo get_phrases(['total']); ?></label></td>
                                        <td><input type="text" id="total_amount" class="form-control text-right" readonly="" value="0"></td>
...
<div class="modal fade bd-example-modal-lg" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                <?php echo form_open('account/vouchers/editDebitVoucher', 'class="needs-validation" id="editdebitForm" novalidate="" data="editdebitCallBackData"')?>
    ...
    <span style="display:none ;" id="testtitle" class="text-center">Debit Voucher</span>
</div>
<script src="<?php echo base_url() ?>/assets/plugins/jquery-ui-1.12.1/jquery-ui.min.js" type="text/javascript">
</script>

<script type="text/javascript">
    var debitCallBackData = function() {
        $('#add-modal').modal('hide');
        $('#debitForm')[0].reset();
        $('#debitForm').removeClass('was-validated');
        $('#approvalList').DataTable().ajax.reload(null, false);
    }
    var editdebitCallBackData = function() {
        $('#edit-modal').modal('hide');
        $('#editDetails').html('');
        $('#editdebitForm').removeClass('was-validated');
        $('#approvalList').DataTable().ajax.reload(null, false);
    }
    ...
    $(document).ready(function() {
        ...
        $('#approvalList').DataTable({
            ...
            .prepend('<div  class="col-md-6 text-center" style="position:absolute; top:10; left:80px;"><h6>'+$companytitle+'</h6><strong><u class="pt-4">Debit Voucher</u></strong></div>')
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': _baseURL + 'account/vouchers/getVoucherList/DV',
                'data': function(d) {
...
// $('#credit_head').select2().trigger('change');
        $.ajax({
            type: 'GET',
            url: _baseURL + 'account/vouchers/debOrCHead',
            dataType: 'json',

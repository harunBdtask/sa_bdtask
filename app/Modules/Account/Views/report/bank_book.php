...
<div class="row">
   <div class="col-sm-12">
      ...
      <div class="card">
         ...
         <div class="card-body">
            <?php echo form_open('account/reports/bank_book')?>
             <div class="col-sm-12">
               <input type="hidden" id="txtName" name="txtName"/>
               <div class="form-group row">
                  <label for="date" class="col-sm-2 col-form-label"><?php echo get_phrases(['select','bank'])?></label>
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-3">
                     <input type="text" name="dtpFromDate" value="<?php echo (!empty($dtpFromDate)?$dtpFromDate:'')?>" placeholder="<?php echo get_phrases(['date']) ?>" class="datepicker form-control" autocomplete="off">
                  </div>
                  <div class="col-sm-3">
                     <input type="text"  name="dtpToDate" value="<?php echo (!empty($dtpToDate)?$dtpToDate:'')?>" placeholder="<?php echo get_phrases(['date']) ?>" class="datepicker form-control" autocomplete="off">
                  </div>
                  <div class="col-sm-2">
                     <button type="submit" name="btnSave" class="btn btn-success w-md m-b-5"><?php echo get_phrases(['find']) ?></button>
                  </div>
               </div>
               </div>
            <?php echo form_close()?>
               ...
               <div class="prcontent"  id="printArea">
                  ...
                  <div>
                     ...
                     <div class="table-responsive">
                        <div class="text-center"> <strong> <?php echo get_phrases(['bank','book','report'])?>  (<?php echo get_phrases(['from'])?> <?php echo (!empty($dtpFromDate)?$dtpFromDate:''); ?> <?php echo get_phrases(['to'])?> <?php echo (!empty($dtpToDate)?$dtpToDate:'');?>)</strong></div>
                ...
                <tr>
                    <td height="25" width="10%" style="background: #abbff9!important"><strong><?php echo get_phrases(['sl']);?></strong></td>
                    ...
                    <td width="10%" style="background: #abbff9!important"><strong><?php echo get_phrases(['voucher','type']);?></strong></td>
                    
                    <td width="10%" style="background: #abbff9!important"><strong><?php echo "Head Name";?></strong></td>
                    
                     <td width="15%" style="background: #abbff9!important"><strong><?php echo get_phrases(['ledger','comment'])?></strong></td>

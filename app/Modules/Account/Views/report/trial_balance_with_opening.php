    ...
    $(document).ready(function(){
        ...
        $('#balanceList').DataTable({ 
          ...
          'columns': [
             { data: 'HeadCode' },
             { data: 'HeadName' },
             { data: 'opening_dbt', className: "text-right" },
             { data: 'opening_crt' , className: "text-right"},
             { data: 'trdebit', className: "text-right" },
             { data: 'trcredit', className: "text-right" },
             { data: 'cldebit', className: "text-right" },
             { data: 'clcredit', className: "text-right" }
          ],
        });

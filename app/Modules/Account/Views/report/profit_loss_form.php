...
<div class="row">
    <div class="col-sm-12">
        <?php if($permission->method('profit_loss', 'create')->access() || $permission->method('profit_loss', 'read')->access()){ ?>
        <div class="card">
            ...
            <div class="card-body">
                <?php echo form_open('account/reports/profitLossReoprtResult')?>
            <div class="row">
                  
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                        <input type="text" name="dtpFromDate" value="<?php echo date('Y-m-01')?>" placeholder="<?php echo get_phrases(['from','date']) ?>" class="datepickerui form-control" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                        <input type="text"  name="dtpToDate" value="<?php echo date('Y-m-t')?>" placeholder="<?php echo get_phrases(['to','date']) ?>" class="datepickerui form-control" autocomplete="off">
                        </div>
                    </div>

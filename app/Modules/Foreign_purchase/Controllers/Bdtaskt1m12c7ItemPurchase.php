...
use App\Modules\Foreign_purchase\Models\Bdtaskt1m12ItemPurchaseModel;
...
class Bdtaskt1m12c7ItemPurchase extends BaseController
{
    ...
    *--------------------------*/
    public function index()
    {
        ...
        $data['hasPrintAccess']        = $this->permission->method('wh_foreign_purchase_received_voucher', 'print')->access();
        $data['hasExportAccess']        = $this->permission->method('wh_foreign_purchase_received_voucher', 'export')->access();
        
        $data['store_list']     = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_05_getResultWhere('ah_material_store', array('status'=>1,'branch_id'=>session('branchId')));
        $data['supplier_list']  = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_05_getResultWhere('ah_supplier_information', array('status'=>1));
    ...
    *--------------------------*/
    ...
    { 
        $data = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_06_Deleted('ah_material', array('id'=>$id));
    ...
    *--------------------------*/
    ...
    { 
        ...
        if (! $this->validate($rules)) {
            ...
            if($action=='add'){
                $isExist = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_03_getRow('ah_material_requisition', array('voucher_no'=>$this->request->getVar('voucher_no')));
                //$isExist2 = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_03_getRow('ah_material', array('nameA'=>$this->request->getVar('nameA')));
                if( !empty($isExist)  ){
                    $response = array(
                            'success'  =>'exist',
                    ...
                    //$data['image'] = $filePath;
                    $result = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_01_Insert('ah_material_requisition',$data);
                    ...
                    $result2 = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_01_Insert_Batch('ah_material_requisition_details',$data2);
                    ...
                    foreach($item_id as $key => $item){
                        ...
                        if( $affectedRows ==0 ){
                            ...
                            $result = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_01_Insert('ah_material_stock',$data3);
                        }
                    }*/
                ...
                $result = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_02_Update('ah_material_requisition',$data, array('id'=>$id));
                if($result){
                     $response = array(
                        'success'  =>true,
    ...
    *--------------------------*/
    ...
    { 
        $data = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_03_getRow('ah_material', array('id'=>$id));
        echo json_encode($data);
    }
    ...
    *--------------------------*/
    ...
    { 
        ...
        $material_receive_id = $this->request->getVar('rv_id');
        ...
        $purchases_details = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_05_getResultWhere('ah_material_receive_details', array('rv_id'=>$material_receive_id));

        foreach($purchases_details as $details)
        {
            $item_row = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_03_getRow('ah_material', array('id'=>$details->item_id));            
    ...
    *--------------------------*/
    ...
    { 
        ...
        $purchases_details = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_05_getResultWhere('ah_material_requisition_details', array('purchase_id'=>$purchase_id));
        ...
        foreach($purchases_details as $details)
        {
            ...
            $return_details = $this->bdtaskt1m12c7_02_CmModel->bdtaskt1m1_03_getRow('ah_material_return_details', array('purchase_id'=>$purchase_id,'item_id'=>$details->item_id));

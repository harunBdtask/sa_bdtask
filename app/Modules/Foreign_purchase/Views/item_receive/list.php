...
<div class="modal fade bd-example-modal-xl" id="item_receive-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog" >
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('foreign_purchase/add_item_receive', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
            <div class="modal-body">
                ...
                <!-- <input type="hidden" name="credit_period" id="credit_period" value=""> -->
                    ...
                    <div class="row">
                        ...
                        <label for="date" class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['Recive','date'])?> <i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                         ...
                         <table class="table table-sm table-stripped w-100" id="receive_table">
                            <thead>
                                <tr>
                                    ...
                                    <th width="5%" class="text-right"><?php echo get_phrases(['available','quantity'])?></th>
                                    ...
                                    <th width="10%" class="text-center"><?php echo get_phrases(['store'])?></th>
...
<script type="text/javascript">
    ...
    function get_purchase_details(purchase_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'foreign_purchase/getItemPurchaseDetailsById';
    ...
    $(document).ready(function() { 
       ...
       "use strict";       
        ...
        $('#item_receiveList').on('click', '.actionEdit', function(e){
            ...
            var submit_url = _baseURL+'foreign_purchase/getItemReceiveById/'+id;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#supplier_id').val(data.po_supplier_id);
                    $('#voucher_show').html(data.po_code);
                    $('#date_show').html(data.po_date);

                    getMAXID('ah_material_receive','rv_id','voucher_no','RVC-');
        ...
        $('#item_receiveList').on('click', '.actionPreview', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'foreign_purchase/getItemReceiveDetailsById/'+id;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#itemPurchaseDetails_date').text(data.po_date);
                    $('#itemPurchaseDetails_voucher_no').text(data.po_code);
                    $('#itemPurchaseDetails_sub_total').text(data.po_subtotal);
                    $('#itemPurchaseDetails_grand_total').text(data.po_grand_total);
        ...
        $('#item_receiveList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'foreign_purchase/getItemReceive',
               'data':function ( d ) {
        ...
        $('#item_receiveList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"foreign_purchase/deleteItemReceive/"+id;
    ...
    function get_item_details(purchase_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'foreign_purchase/getItemPurchasePricingDetailsById';
    ...
    function item_info(item_id,sl){
        ...
        $.ajax({
            url: _baseURL+"foreign_purchase/getItemDetailsById/"+item_id,
            type: 'POST',

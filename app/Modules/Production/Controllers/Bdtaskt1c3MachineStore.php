...
use App\Modules\Production\Models\Bdtaskt1MachineStoreModel;
...
class Bdtaskt1c3MachineStore extends BaseController
{
    ...
    *--------------------------*/
    public function index()
    {
        ...
        $data['hasCreateAccess']        = $this->permission->method('plant_list', 'create')->access();
        $data['hasPrintAccess']        = $this->permission->method('plant_list', 'print')->access();
        $data['hasExportAccess']        = $this->permission->method('plant_list', 'export')->access();

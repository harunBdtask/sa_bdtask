...
use App\Modules\Production\Models\Bdtaskt1ItemApproveModel;
    ...
    { 
        ...
        foreach($request_details as $details)
        {
            ...
            $html .= '<tr>
                        ...
                        <td width="20%" align="right" class="valign-middle">'.$details->qty.'<input type="hidden" name="qty'.$item_counter.'" id="qty'.$item_counter.'" value="'.$details->qty.'"></td>                        
                        <td width="20%" class="valign-middle" align="right">'.$total_avail_qty.'<input type="hidden" name="avail_qty'.$item_counter.'" id="avail_qty'.$item_counter.'" value="'.$total_avail_qty.'"></td>
                        <td width="20%" class="valign-middle" align="right">'.$aqty.'<input type="hidden" name="aqty'.$item_counter.'" id="aqty'.$item_counter.'" value="'.$aqty.'"></td>

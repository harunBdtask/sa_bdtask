       ...
       <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label for="filter_voucher_no" class="font-weight-600"><?php echo get_phrases(['consumption','no']) ?> </label>
                        <select name="filter_voucher_no" id="filter_voucher_no" class="custom-select form-control" >
                            <option value=""></option>
                            <?php if(!empty($machine_requests_list)){ ?>
                                <?php foreach ($machine_requests_list as $key => $value) {?>
                ...
                <table id="item_approveList" class="table display table-bordered table-striped table-hover compact" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo get_phrases(['consumption','no']);?></th>

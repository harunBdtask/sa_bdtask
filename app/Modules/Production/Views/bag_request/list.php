       ...
       <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">      
                    ...
                    <div class="col-sm-3">
                        <label for="filter_production_id" class="font-weight-600"><?php echo get_phrases(['production','voucher']) ?> </label>
...
<div class="modal fade bd-example-modal-xl" id="item_request-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl" >
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('production/bags/add_item_request', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
            <div class="modal-body">
                <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                <input type="hidden" name="id" id="id" />
                <input type="hidden" name="action" id="action" value="add" />
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label font-weight-600"><?php echo get_phrases(['production','voucher','no'])?></label>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="table-responsive">
                                 <table class="table table-stripped w-100" id="request_table">
                                    <thead>
                                        <tr>
                                            <th width="60%" class="text-center"><?php echo get_phrases(['item', 'name'])?><i class="text-danger">*</i></th>
                                            <th width="20%" class="text-center"><?php echo get_phrases(['required','qty'])?></th>
                                            <th width="20%"><?php echo get_phrases(['unit'])?></th>
...
<div class="modal fade bd-example-modal-xl" id="itemRequestDetails-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl" >
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('production/bags/item_collect', 'class="ajaxForm needs-validation" id="ajaxForm2" novalidate="" data="showCallBackData2"');?>
            <div class="modal-body" id="printContent">
                ...
                <div class="row">
                    <label class="col-sm-2 text-right font-weight-600"><?php echo get_phrases(['production','voucher']) ?> : </label>
                    <div class="col-sm-4">
...
<script type="text/javascript">
    ...
    function add_item_row(item_counter) {
        ...
        var html = '<tr><td><select name="item_id[]" id="item_id'+item_counter+'" class="form-control custom-select" onchange="item_info(this.value,'+item_counter+')" required><option value=""></option>'+<?php foreach($item_list as $items){?>
                                    '<option value="<?php echo $items->finish_goods;?>"><?php echo $items->nameE;?></option>'+
                                   <?php }?>
                                '</select></td><td><input type="text" name="qty[]" class="form-control text-right onlyNumber" id="qty'+item_counter+'" required autocomplete="off" ></td><td class="valign-middle"><span id="unit'+item_counter+'"></span></td></tr>';
    ...
    $(document).ready(function() { 
       ...
       $('#collect').on('click', function(e) {
        ...
        $('#production_id').on('select2:select', function() {
            ...
            if(production_id !='' ){
                var submit_url = _baseURL+'production/bags/getProductionRecipeDetailsById';
                    ...
                    success: function(data) {
                        ...
                        if(data != null){
                            ...
                            $.each(data, function(index, value){
                                ...
                                if(value.bag_id == null || value.bag_id == ''){
                                    toastr.warning('<?php echo get_notify("bag_not_found_for_item"); ?> '+value.item_name);
        ...
        $('.addShowModal').on('click', function(){
            ...
            getMAXID('wh_bag_requests','id','voucher_no','BGR-');
            ...
            $('#item_requestModalLabel').text('<?php echo get_phrases(['new','consumption','request','to','bag','store']);?>');
        ...
        $('#item_requestList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'production/bags/getItemRequestDetailsById/'+id;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#itemRequestDetails_production_id').text(data.production_no);
        ...
        $('#item_requestList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'production/bags/getItemRequest',
               'data':function ( d ) {
        ...
        $('#item_requestList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'production/bags/getItemRequestById/'+id;
        ...
        $('#item_requestList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"production/bags/deleteItemRequest/"+id;
    ...
    function item_info(item_id,sl){
        ...
        if(item_id >0 ){
            $.ajax({
                url: _baseURL+"production/bags/getItemDetailsById/"+item_id,
                type: 'POST',
    ...
    function get_item_details(request_id){
        ...
        if(request_id !='' ){
            var submit_url = _baseURL+'production/bags/getItemRequestQuantityDetailsById';

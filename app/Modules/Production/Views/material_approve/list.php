...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#item_approveList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'production/getItemApproveById/'+id;
        ...
        $('#item_approveList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"production/deleteItemApprove/"+id;
    ...
    function get_item_details_return(request_id){
        ...
        if(request_id !='' ){
            var submit_url = _baseURL+'production/getItemCollectQuantityDetailsById';

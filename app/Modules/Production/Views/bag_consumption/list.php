       ...
       <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label for="filter_voucher_no" class="font-weight-600"><?php echo get_phrases(['bag','consumption','no']) ?>  </label>
                        <select name="filter_voucher_no" id="filter_voucher_no" class="custom-select form-control">
                            <option value=""></option>
                            <?php if(!empty($bag_requests_list)){ ?>
                                <?php foreach ($bag_requests_list as $key => $value) {?>
                ...
                <table id="item_approveList" class="table display table-bordered table-striped table-hover compact" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo get_phrases(['bag','consumption','no']);?></th>
...
<div class="modal fade bd-example-modal-xl" id="ItemApproveDetails-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl" >
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('production/bags/add_item_approve', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
...
<script type="text/javascript">
    ...
    function reset_table(){
        ...
        $('#filter_production_id').val('').trigger('change');
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#item_approveList').on('click', '.actionPreview', function(e){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#ItemApproveDetails_production_id').text(data.production_no);
        ...
        $('#item_approveList').on('click', '.actionApprove', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'production/bags/getItemApproveDetailsById/'+id;
        ...
        $('#item_approveList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'production/bags/getItemApprove',
               'data':function ( d ) {
    ...
    function get_item_details(request_id, production_id){
        ...
        if(request_id !='' ){
            var submit_url = _baseURL+'production/bags/getItemApproveQuantityDetailsById';

                    ...
                    <div class="form-group row">
                        <label for="firstname" class="col-sm-3 col-form-label"><?php echo get_phrases(['firstname']); ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="lastname" class="col-sm-3 col-form-label"><?php echo get_phrases(['lastname']); ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-sm-3 col-form-label"><?php echo get_phrases(['email']); ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-sm-3 col-form-label"><?php echo get_phrases(['password']) ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-9">
                            <input name="password" class="form-control" type="password" placeholder="<?php echo get_phrases(['password']) ?>" id="password">
                         <input name="old_password" class="form-control" type="hidden" value="<?php echo $user->password;?>" id="hidden">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="about" class="col-sm-3 col-form-label"><?php echo get_phrases(['about']) ?></label>
                        <div class="col-sm-9">
                            <textarea name="about" placeholder="<?php echo get_phrases(['about']) ?>" class="form-control" id="about"><?php echo $user->about ?></textarea>
                        </div>
                    </div>


                    <div class="form-group row">
                        <label for="preview" class="col-sm-3 col-form-label"><?php echo get_phrases(['preview']) ?></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="image" class="col-sm-3 col-form-label"><?php echo get_phrases(['image']) ?></label>
                        <div class="col-sm-9">

                            ...
                            <tr>
                                ...
                                <td><?php echo $value->ip_address; ?></td>
                                 <td>
                                    ...
                                    <a href="<?php echo base_url('user/delete_user/'.$value->id)?>" onclick="return confirm('<?php echo get_phrases(["are_you_sure"]) ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="far fa-trash-alt" aria-hidden="true"></i></a>
                                <?php }?>
                                    <?php } else { ?> 

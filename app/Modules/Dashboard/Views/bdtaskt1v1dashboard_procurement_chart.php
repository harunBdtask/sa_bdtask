<div class="row">
    <div class="col-sm-6 col-md-12 col-lg-6 col-xl-3 d-flex mb-3">
        <div class="info-box d-flex position-relative rounded flex-fill w-100 overflow-hidden gradient-five">
            ...
            <span class="info-box-icon d-flex align-self-center text-center">
                <img src="<?php echo base_url() ?>/assets/dist/img/icon/png/supplier.png" alt="" height="64" width="64">
            </span>
            <div class="info-box-content d-flex flex-column justify-content-center">
                <span class="info-box-text fw-bold fs-17px"><?php echo get_phrases(['total', 'suppliers']); ?></span>
                <span class="info-box-number d-block fw-black counter"><?php echo count($suppliers); ?></span>
                <div class="progress">
    ...
    <div class="col-sm-6 col-md-12 col-lg-6 col-xl-3 d-flex mb-3">
        ...
        <div class="position-br	mb-n5 mr-n5 radius-round bgc-purple-l1 opacity-5" style="width: 5rem; height: 5rem;"></div>
        <span class="info-box-icon d-flex align-self-center text-center">
            <img src="<?php echo base_url() ?>/assets/dist/img/icon/png/smartphone.png" alt="" height="64" width="64">
        </span>
        <div class="info-box-content d-flex flex-column justify-content-center">
            <span class="info-box-text fw-bold fs-17px"><?php echo get_phrases(['total', 'purchase', 'quantity']); ?></span>
            <span class="info-box-number d-block fw-black counter"><?php echo number_format($purchase_grand_total->grand_total?$purchase_grand_total->grand_total:0); ?></span>
            <div class="progress">
                <div class="progress-bar" style="width: 70%"></div>
            </div>
        </div>
...
<div class="col-sm-6 col-md-12 col-lg-6 col-xl-3 d-flex mb-3">
    <div class="info-box d-flex position-relative rounded flex-fill w-100 overflow-hidden gradient-seven">
        ...
        <div class="position-br	mb-n5 mr-n5 radius-round bgc-purple-l1 opacity-5" style="width: 5rem; height: 5rem;"></div>
        <span class="info-box-icon d-flex align-self-center text-center">
            <img src="<?php echo base_url() ?>/assets/dist/img/icon/png/choices.png" width="64">
        </span>
        <div class="info-box-content d-flex flex-column justify-content-center">
            <span class="info-box-text fw-bold fs-17px"><?php echo get_phrases(['total', 'purchase', 'order']); ?></span>
            <span class="info-box-number d-block fw-black counter"><?php echo ($purchase_qty->qty?$purchase_qty->qty:0); ?></span>
            <div class="progress">
                <div class="progress-bar" style="width: 70%"></div>
            </div>
        </div>
...
<div class="card mb-3">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 font-weight-600 mb-0"><?php echo get_phrases(['raw', 'materials', 'orders', 'next', '2', 'days']); ?></h6>
            </div>
        </div>
    </div>
    <div class="card-body">
        <table id="poItemList" class="table table-bordered table-hover table-striped mb-0">
            <thead>
                <tr>
                    <th><?php echo get_phrases(['sl']); ?></th>
                    <th><?php echo get_phrases(['PO', 'no']); ?></th>
                    <th><?php echo get_phrases(['supplier', 'name']); ?></th>
                    <th><?php echo get_phrases(['item', 'name']); ?></th>
                    <th><?php echo get_phrases(['quantity']); ?></th>
                </tr>
            </thead>
            <tbody>
...
<script>
    $(document).ready(function() {
        ...
        var po_date = "<?php echo date('Y-m-d', strtotime(' - 2 days'));?>";
        $('#poItemList').DataTable({ 
            lengthChange: true,
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'dashboard/po_list',
               'data':{'csrf_stream_name':csrf_val,'po_date':po_date}
            },
            'columns': [
             { data: 'id' ,
                render: function (data, type, row, meta) {

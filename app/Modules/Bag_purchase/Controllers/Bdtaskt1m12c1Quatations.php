...
use App\Modules\Bag_purchase\Models\Bdtaskt1m12QuatationsModel;
...
class Bdtaskt1m12c1Quatations extends BaseController
{
    ...
    { 
        ...
        if (! $this->validate($rules)) {
            ...
            if($action=='add'){
                ...
                $spr_status = $this->bdtaskt1m12c1_02_CmModel->bdtaskt1m1_03_getRow('wh_bag_requisition', array('id'=>$data['requisition_id'], 'received'=>1));
                if(!empty($spr_status)){
                    $response = array(
                        'success'  =>false,
    ...
    *--------------------------*/
    ...
    { 
        ...
        $item_row = $this->bdtaskt1m12c1_02_CmModel->bdtaskt1m1_03_getRow('wh_bag', array('id'=>$item_id));  
    ...
    *--------------------------*/
    ...
    public function bdtaskt1m12c10_07_approvePurchaseOrder()
    {
        ...
        $quatation_id = $this->request->getVar('quatation_id');
        $data = $this->bdtaskt1m12c1_02_CmModel->bdtaskt1m1_03_getRow('wh_bag_requisition', array('id'=>$id, 'isApproved'=>0));
        ...
        if (!empty(session('id'))) {
            ...
            $result = $this->bdtaskt1m12c1_02_CmModel->bdtaskt1m1_02_Update('wh_bag_requisition',$data, array('id'=>$id));
    ...
    { 
        ...
        $data = $this->bdtaskt1m12c1_02_CmModel->bdtaskt1m1_03_getRow('wh_bag_requisition', array('id'=>$id));
        echo json_encode($data);
    }

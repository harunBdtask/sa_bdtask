...
<div class="modal fade bd-example-modal-xl" id="item_purchase-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog" >
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('bag_purchase/add_requisition', 'class="po_ajaxForm needs-validation" id="po_ajaxForm" novalidate="" data="po_showCallBackData"');?>
...
<div class="modal fade bd-example-modal-xl" id="purchaseOrderDetails-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('bag_purchase/requisition_approve', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
        ...
        $('#purchase_orderList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'bag_purchase/getRequisitionDetailsById/'+id;
        ...
        $('#purchase_orderList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'bag_purchase/getRequisition',
               'data':function ( d ) {
        ...
        $('#purchase_orderList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"bag_purchase/deleteRequisition/"+id;
    ...
    function get_item_details_edit(purchase_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'bag_purchase/getRequisitionItemDetailsById';
    ...
    function get_item_details(purchase_id, supplier_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'bag_purchase/getRequisitionPricingDetailsById';
    ...
    function get_item_list(){
         $.ajax({
            url: _baseURL+"bag_purchase/get_item_list_bag",
            type: 'POST',
            data: {'csrf_stream_name':csrf_val},
            dataType:"html",
            async: false,
    ...
    function po_item_info(item_id,sl){
        ...
        $.ajax({
            url: _baseURL+"bag_purchase/getSupplierItemDetailsByIdBag",
            type: 'POST',

...
<div class="modal fade bd-example-modal-xl" id="item_receive-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog" >
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('bag_purchase/add_item_receive', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
...
<script type="text/javascript">
    ...
    function get_po_list(){
        preloader_ajax();
        $.ajax({
            url: _baseURL+"bag_purchase/get_po_list",
            type: 'POST',
    ...
    function getItemReceiveById(id){
        ...
        $('#gr_no').val('');
        if (id) {
            var submit_url = _baseURL+'bag_purchase/getItemReceiveById/'+id;
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function get_purchase_details(purchase_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'bag_purchase/getItemPurchaseDetailsById';
    ...
    $(document).ready(function() { 
       "use strict";       
        ...
        $('#item_receiveList').on('click', '.actionPreview', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'bag_purchase/getItemReceiveDetailsById/'+id;
        ...
        $('#item_receiveList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'bag_purchase/getItemReceive',
               'data':function ( d ) {
        ...
        $('#item_receiveList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"bag_purchase/deleteItemReceive/"+id;
    ...
    function get_item_details(purchase_id, supplier_id){
        ...
        if(purchase_id !='' ){
            var submit_url = _baseURL+'bag_purchase/getItemPurchasePricingDetailsById';
    ...
    function item_info(item_id,sl){
        ...
        $.ajax({
            url: _baseURL+"bag_purchase/getItemDetailsById/"+item_id,
            type: 'POST',

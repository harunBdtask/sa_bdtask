...
<div class="modal fade bd-example-modal-xl" id="item_purchase-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog" >
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('bag_purchase/add_quatation', 'class="po_ajaxForm needs-validation" id="po_ajaxForm" novalidate="" data="showCallBackData"');?>
...
<div class="modal fade bd-example-modal-xl" id="purchaseOrderDetails-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('bag_purchase/requisition_approve', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData55"');?>
...
<script type="text/javascript">
    ...
    function reload_table(){
        ...
        if (filter_name != '') {
            var submit_url = _baseURL+'bag_purchase/getSpr';
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    $(document).ready(function() {
        ...
        $('#quatationList').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': _baseURL + 'bag_purchase/getQuatation',
                'data':function ( d ) {
        ...
        $('#quatationList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'bag_purchase/getSprDetailsById/'+id;
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
        ...
        $('#quatationList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            $('#po_id').val(id);
            var submit_url = _baseURL+'bag_purchase/getQuatationById/'+id;
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
        ...
        $('#quatationList').on('click', '.actionDelete', function(e) {
            ...
            var submit_url = _baseURL + "bag_purchase/deleteQuatation/" + id;
    ...
    function downloadContent(id) {
        var html = $("#"+id).html();
        var submit_url = _baseURL+'bag_purchase/quatation_dompdf';
        preloader_ajax();
        $.ajax({
            type: 'POST',
            url: submit_url,
    ...
    function get_item_details(spr_id, quatation_id){
        if(spr_id !='' ){
            var submit_url = _baseURL+'bag_purchase/getQuatationPricingDetailsById';
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function get_item_list(requisition_id, qid){
        preloader_ajax();
        $.ajax({
            url: _baseURL+"bag_purchase/get_spr_list",
            type: 'POST',
    ...
    function get_item_details_edit(purchase_id){
        if(purchase_id !='' ){
            var submit_url = _baseURL+'bag_purchase/get_quatation_details_by_id';
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
    ...
    function po_item_info(item_id,sl){
        if (item_id != '') {
            ...
            preloader_ajax();
            $.ajax({
                url: _baseURL+"bag_purchase/getSprItemDetailsById",
                type: 'POST',

...
<div class="modal fade bd-example-modal-xl" id="item_purchase-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog" >
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('bag_purchase/addPurchaseOrder', 'class="po_ajaxForm needs-validation" id="po_ajaxForm" novalidate="" data="po_showCallBackData"');?>
...
<div class="modal fade bd-example-modal-xl" id="purchaseOrderDetails-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart('bag_purchase/purchase_order_approve', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                ...
                <div class="body-content mb-5">
                    <div id="printContent2" class="mt-3 mb-3" style="max-width: 1020px; margin: auto; background-color: #fff; padding: 50px">
...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
        ...
        $('#purchase_orderList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'bag_purchase/getPurchaseOrder',
               'data':function ( d ) {
        ...
        $('#purchase_orderList').on('click', '.actionEdit', function(e){
            ...
            var submit_url = _baseURL+'bag_purchase/getPurchaseOrderDetailsById/'+id;
            preloader_ajax();
            $.ajax({
                type: 'POST',
                url: submit_url,
        ...
        $('#purchase_orderList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"bag_purchase/deletePurchaseOrder/"+id;
    ...
    function get_item_details(requisition_id, item_id, po_id=null){
        if(requisition_id !='' ){
            ...
            $.ajax({
                type: 'POST',
                url: _baseURL+"bag_purchase/get_quatation_list",
                dataType : 'html',
                async: false,
    ...
    function get_spr_item_list(requisition_id, selected_id=null){
        preloader_ajax();
        $.ajax({
            url: _baseURL+"bag_purchase/get_spr_item_list",
            type: 'POST',

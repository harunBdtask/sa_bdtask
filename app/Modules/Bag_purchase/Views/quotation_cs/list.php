...
<div class="modal fade bd-example-modal-xl" id="quotation_cs-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl custom-modal-dialog" >
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('bag_purchase/add_purchase_order', 'class="po_ajaxForm needs-validation" id="po_ajaxForm" novalidate="" data="po_showCallBackData"');?>
...
<script type="text/javascript">
    ...
    function get_quatation_list(requisition_id, item_id=null, po_id=null){
        if(item_id !='' ){
            preloader_ajax();
            $.ajax({
                url: _baseURL+"bag_purchase/get_quatation_cs",
                type: 'POST',
    ...
    function get_item_list(supplier_id){
        preloader_ajax();
        $.ajax({
            url: _baseURL+"bag_purchase/get_item_list",
            type: 'POST',
    ...
    function po_item_info(item_id,sl){
        ...
        // preloader_ajax();
        $.ajax({
            url: _baseURL+"bag_purchase/getSupplierItemDetailsById",
            type: 'POST',

            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <h6><?php echo 'DO NO :' . ($do_main ? $do_main->vouhcer_no : ''); ?></h6>
               ...
               <div class="col-sm-4">
                ...
                <div class="form-group row">
                    <label for="name" class="col-sm-2 col-form-label text-center"> <?php if ($do_main->sls_admin_signature) { ?><img src="<?php echo base_url($do_main->sls_admin_signature) ?>" height="70px;" width="80px;"><?php } ?><div class="border-top"><?php echo get_phrases(['sales', 'admin']) ?></div></label>

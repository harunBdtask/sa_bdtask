...
<div class="modal fade bd-example-modal-xl" id="main_store-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
           ...
           <?php echo form_open_multipart('bag_store/add_main_store', 'class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData"');?>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#main_storeList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'bag_store/getMainStoreDetailsById/'+id;
        ...
        $('#main_storeList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'bag_store/getMainStore',
               'data':{'csrf_stream_name':csrf_val}
            },
          'columns': [
             { data: 'id' },
        ...
        $('#main_storeList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'bag_store/getMainStoreById/'+id;
        ...
        $('#main_storeList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"bag_store/deleteMainStore/"+id;

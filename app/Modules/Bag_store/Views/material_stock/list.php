       ...
       <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">  
                    ...
                    <div class="col-sm-3">
                        <label for="filter_company_code" class="font-weight-600"><?php echo get_phrases(['company','code']) ?> </label>
    ...
    $(document).ready(function() { 
       "use strict";
        ...
        $('#main_stockList').on('click', '.actionPreview', function(e){
            ...
            var submit_url = _baseURL+'bag_store/getMainStockDetailsById/'+id;
        ...
        $('#main_stockList').DataTable({ 
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': _baseURL + 'bag_store/getMainStock',
               'data':function ( d ) {
        ...
        $('#main_stockList').on('click', '.actionEdit', function(e){
            ...
            var id = $(this).attr('data-id');
            var submit_url = _baseURL+'bag_store/getMainStockById/'+id;
        ...
        $('#main_stockList').on('click', '.actionDelete', function(e){
            ...
            var submit_url = _baseURL+"bag_store/deleteMainStock/"+id;
